...
import javax.servlet.http.HttpServletRequest;
	...
	public class ConversorTipos implements Serializable {
	 ...
	 /*   // facilita o acesso ao conteúdo dos dados,
	    // quando o formulário os passa com "enctype=MultiPart/form-data")
	    public static byte[] getByteArray(FormMultiPart multi, String parametro)
	    {
	        MimeSinglePart single = (MimeSinglePart) multi.getPart(parametro);
	        if (single == null)
	            return null;       
	        return single.getBody();
	    }    
	       
	    // facilita o acesso ao conteúdo dos dados,
	    // quando o formulário os passa com "enctype=MultiPart/form-data")
	    public static String getParameter(FormMultiPart multi, String parametro)
	    {
	        MimeSinglePart single = (MimeSinglePart) multi.getPart(parametro);
	        if (single == null)
	            return "";       
	        return new String(single.getBody());
	    }    */
	    ...
	    public static float getFloatPrecisaoDoisDigitos(float f)
	    {
	        ...
	        {
	            //LoggerKamaleon.error(ConversorTipos.class, "ERRO DE PARSE", erro);
	        }
	     ...
	     * Caso o parametro seja nulo, retorna 0
	     *//*
	    public static int getInt(FormMultiPart multi, String s)
	    {
	        s = getParameter(multi, s);
	        if ((s == null) || (s.equals(""))) 
	            return 0;
	        else return Integer.parseInt(s);
	    }*/

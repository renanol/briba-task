...
public class FuncoesNumeros {
	...
	public static NumberFormat nf0digitosDecimais = NumberFormat.getNumberInstance(Locale.ITALY);

	public static NumberFormat nf2digitosDecimais = NumberFormat.getNumberInstance(Locale.ITALY);

	public static NumberFormat nf3digitosDecimais = NumberFormat.getNumberInstance(Locale.ITALY);

	public static NumberFormat nf4digitosDecimais = NumberFormat.getNumberInstance(Locale.ITALY);

	public static NumberFormat nfNdigitosDecimais = NumberFormat.getNumberInstance(Locale.ITALY);
	...
	throws ParseException
	{
		...
		return nf2digitosDecimais.parse(i.replace(".", ",")).doubleValue();
	}
